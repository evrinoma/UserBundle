...
use Evrinoma\UserBundle\DtoCommon\ValueObject\Mutable\GrantInterface;
...
interface UserApiDtoInterface extends IdInterface, ActiveInterface, NameInterface, PasswordInterface, UsernameInterface, EmailInterface, RolesInterface, SurnameInterface, PatronymicInterface, ExpiredAtInterface, GrantInterface
{
}
